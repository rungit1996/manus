...
def register_exception_handlers(app: FastAPI) -> None:
    """处理 Manus 项目中所有的异常并进行统一处理，涵盖：自定义业务状态异常、HTTP 异常、通用异常"""

    @app.exception_handler(AppException)
    async def app_exception_handler(req: Request, e: Exception) -> JSONResponse:
        """处理 Manus 业务异常，将所有状态统一响应结构"""
    ...
    async def exception_handler(req: Request, e: Exception) -> JSONResponse:
        """处理 Manus 中抛出的未定义的任意异常，将状态码统一设置为 500"""
